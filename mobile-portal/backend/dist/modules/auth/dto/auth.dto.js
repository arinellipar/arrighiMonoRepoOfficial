...
exports.RefreshTokenDto = exports.AuthResponseDto = exports.RegisterDto = exports.LoginDto = void 0;
...
], LoginDto.prototype, "documento", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'CPF/CNPJ é obrigatório' }),
    __metadata("design:type", String)
], RegisterDto.prototype, "documento", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(6, { message: 'Senha deve ter no mínimo 6 caracteres' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'Senha é obrigatória' }),
